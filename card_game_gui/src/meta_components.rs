...
impl fmt::Debug for UIDisplay {
        fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        match *self {
            UIDisplay::BLOCK => write!(f, "display: block;"),
            UIDisplay::INLINE => write!(f, "display: inline;"),
            UIDisplay::INLINE_BLOCK => write!(f, "display: inline-block;"),
            UIDisplay::FLEX => write!(f, "display: flex;"),
            UIDisplay::INLINE_FLEX => write!(f, "display: inline-flex;"),
            UIDisplay::GRID => write!(f, "display: grid;"),
            UIDisplay::INLINE_GRID => write!(f, "display: inline-grid;"),
            UIDisplay::FLOW_ROOT => write!(f, "display: flow-root;"),
            UIDisplay::NONE => write!(f, "display: none;"),
            UIDisplay::CONTENTS => write!(f, "display: contents;"),
            UIDisplay::TABLE => write!(f, "display: table;"),
            UIDisplay::TABLE_ROW => write!(f, "display: table-row;"),
            UIDisplay::LIST_ITEM => write!(f, "display: list-item;"),
        }
    }
}

impl fmt::Display for UIDisplay {
        fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "{:?}", self)
    }
}
...
enum UIPosition {
    STATIC,     // top, right, bottom, left, z-index has no effect
    RELATIVE,
    ABSOLUTE,
    FIXED,
    STICKY,
...
struct UIComponentAttributes {
    display: UIDisplay,
    position: UIPosition,
    color: (u32, u32, u32),
    background_color: (u32, u32, u32),
    align_items: UIAlign_Items,
    height: u32,
    width: u32,
    margin: u32, // margin-left, etc
    padding: u32,
    top: u32, 
    bottom: u32, 
    left: u32, 
